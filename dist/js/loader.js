...
*/
      ...
      if (n && r(g.h, m))
        for (g = 0; g < n.length; g++) {
          ...
          if ((k !== k && u.key !== u.key) || k === u.key)
            return { id: m, list: n, index: g, s: u };
        }
      return { id: m, list: n, index: -1, s: void 0 };
    }
    function e(g) {
      this.h = {};
      this.g = b();
  ...
  function na(a, b, c) {
    ...
    for (var d = a.length, e = 0; e < d; e++) {
      var h = a[e];
      if (b.call(c, h, e, a)) return { J: e, N: h };
    }
    return { J: -1, N: void 0 };
  }
  ...
  p("Reflect.set", function (a) {
    return a
      ...
      : function (b, c, d, e) {
          ...
          return h
            ? h.set
              ? (h.set.call(3 < arguments.length ? e : b, d), !0)
              : h.writable && !Object.isFrozen(b)
              ? ((b[c] = d), !0)
              : !1
  ...
  function E(a, b) {
    ...
    a.U = function (d, e, h) {
      for (
        var f = Array(arguments.length - 2), g = 2;
        g < arguments.length;
        g++
      )
        f[g - 2] = arguments[g];
  ...
  function Ca(a) {
    return a instanceof H && a.constructor === H && a.h === Ba
      ? a.g
      : "type_error:Const";
  }
  function I(a) {
  ...
  function L(a) {
    ...
    a instanceof L
      ...
      ? ((this.l = !1),
        ...
        hb(this, b[6] || "", !0),
        (this.m = M(b[7] || "")))
      : ((this.l = !1), (this.i = new N(null, this.l)));
  }
        ...
        var f = "callImmediate" + Math.random(),
          g =
            "file:" == h.location.protocol
              ? "*"
              : h.location.protocol + "//" + h.location.host;
        e = C(function (k) {
  ...
  function Lb() {
    if (A.Promise && A.Promise.resolve) {
      ...
      Ib = function () {
        var b = Mb;
        "function" !== typeof A.setImmediate ||
        (A.Window &&
          A.Window.prototype &&
          ((Xa && K && 0 < K.brands.length) || -1 == $a().indexOf("Edge")) &&
          A.Window.prototype.setImmediate == A.setImmediate)
          ? (Ab || (Ab = Bb()), Ab(b))
          : A.setImmediate(b);
      };
  }
  ...
  function Sb(a, b) {
    if (0 == a.g)
      if (a.i) {
        ...
        if (c.h) {
          for (
            var d = 0, e = null, h = null, f = c.h;
            f && (f.l || (d++, f.g == a && (e = f), !(e && 1 < d)));
            f = f.next
          )
            e || (h = f);
          e &&
...
*/
  ...
  function bc(a) {
    ...
    for (var d = (c = !1); a.l.length && !a.o; ) {
      ...
      if ((h = a.j ? f : h))
        try {
          ...
          g === ec && (g = void 0);
          void 0 !== g &&
            ((a.j = a.j && (g == b || g instanceof Error)), (a.h = b = g));
          if (
            Nb(b) ||
            ("function" === typeof A.Promise && b instanceof A.Promise)
          )
            (d = !0), (a.o = !0);
        } catch (k) {
          (b = k), (a.j = !0), fc(a) || (c = !0);
    ...
    d &&
      ((g = C(a.B, a, !0)),
      (d = C(a.B, a, !1)),
      b instanceof U ? (dc(b, g, d), (b.G = !0)) : b.then(g, d));
...
*/
  ...
  function nc(a) {
    ...
    h = b.attributes || {};
    Wa(h, { type: "text/javascript", charset: "UTF-8" });
    tb(e, h);
    bb(e, a);
    ic(c).appendChild(e);
    return f;
...
*/
  ...
  function tc(a) {
    ...
    c = (d ? "testing-" : "") + b;
    a = "pre-45" == b ? a : c;
    return { version: a, S: c };
  }
  function uc(a) {
    var b = Da[sc].loader,
      c = tc(a);
    return oc(b, { version: c.S }).then(function () {
      var d =
        B("google.charts.loader.versionSpecific.load") ||
        B("google.charts.loader.VersionSpecific.load") ||
        B("google.charts.loader.publicLoad") ||
        B("google.charts.versionSpecific.load");
      if (!d) throw Error("Bad version: " + a);
      rc = function (e) {
        e = d(c.version, e);
        if (null == e || null == e.then) {
          var h =
            B("google.charts.loader.publicSetOnLoadCallback") ||
            B("google.charts.versionSpecific.setOnLoadCallback");
  ...
  D("google.charts.safeLoad", function (a) {
    return Dc(Object.assign({}, a, { safeMode: !0 }));
  });
  function Dc() {
  ...
  function Gc(a, b, c) {
    ...
    var d = c.libraries,
      e = (function (g) {
        ...
        c.other_params
          ? c.other_params.split("&").map(function (g) {
              return g.split("=");
            })
          : []
      ),
      h = Object.assign({}, { key: a, W: d }, e),
      f = "2" === b ? Fc : Ec;
...
//   var Hc = I("https://www.gstatic.com/inputtools/js/ita/inputtools_3.js");
  var Hc = I("dist/js/inputtools_3.js");
  function Ic(a, b, c) {
    wa(c) && c.packages
  ...
  function Lc(a, b, c) {
    ...
    if (d) {
      ...
      b = Ka(mc({ format: Jc, R: e })).toString();
      console.warn(
  ...
  if (sc) console.warn("Google Charts loader.js should only be loaded once.");
    ...
    rc = Z = qc = null;
    B("google.load") ||
      (D("google.load", Mc), D("google.setOnLoadCallback", Cc));
